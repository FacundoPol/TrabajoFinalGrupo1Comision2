...
<div className="acerca-page">
     ...
     <p>
      La aplicación fue construida utilizando las siguientes tecnologías:
       ...
       <ul>
           <li>React.js: Para la construcción de la interfaz de usuario interactiva y dinámica.</li>
           <li>React-Bootstrap: Para un diseño responsivo y cracion de interfaz de usuario.</li>
           <li>React Router DOM: Para la gestión de rutas y la navegación entre las diferentes páginas de la aplicación.</li>
       </ul>
       <br />
